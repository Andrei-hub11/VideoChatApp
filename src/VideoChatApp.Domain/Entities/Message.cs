...
public sealed class Message
{
    ...
    private Message(Guid messageId, Guid roomId, Guid memberId, string content, DateTime sentAt)
    {
        MessageId = messageId;
        RoomId = roomId;
        MemberId = memberId;
    ...
    private static ReadOnlyCollection<ValidationError> ValidateMessage(
        Guid roomId,
        Guid memberId,
        string messageContent,
        DateTime sentAt
